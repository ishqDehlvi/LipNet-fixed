...
from tensorflow.keras.layers import GRU, BatchNormalization, Input
from tensorflow.keras.models import Model
from lipnet.core.layers import CTC  # Ensure this is correct based on your project
...
class LipNet(object):
    ...
    def build(self):
        ...
        # Dense layer with output size for classification
        self.dense1 = Dense(self.output_size, kernel_initializer='he_normal', name='dense1')(self.gru_2)

        # Softmax activation for classification output
        self.y_pred = Activation('softmax', name='softmax')(self.dense1)

        # Labels and lengths for CTC loss
